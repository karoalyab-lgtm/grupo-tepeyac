(function ($) {
  ...
  */
  ...
  /*---------- 01. On Load Function ----------*/
    ...
    $(".ot-menu-wrapper-right").asmobilemenu({
        menuToggleBtn: ".ot-menu-toggle-right",
        bodyToggleClass: "ot-body-visible-right"
    });
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const nextBtn = document.querySelector("#brandNextBtn");
        const indicators = document.querySelectorAll("#brandIndicators button");
        ...
        function setStackClasses() {
            cards.forEach(function (card) {
                card.classList.remove("active", "is-behind-1", "is-behind-2");
            });

            const nextIndex = (currentIndex + 1) % cards.length;
            const nextNextIndex = (currentIndex + 2) % cards.length;

            cards[currentIndex].classList.add("active");
            cards[nextIndex].classList.add("is-behind-1");
            cards[nextNextIndex].classList.add("is-behind-2");
        ...
        function showBrand(index) {
            ...
            setTimeout(function () {
                oldCard.classList.remove("leaving");
                setStackClasses();
                isAnimating = false;
            }, 350);
        }
